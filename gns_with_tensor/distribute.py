...
def get_data_distributed_dataloader_by_samples(path, input_length_sequence, input_length_tensor_sequence, use_material_properties_list,use_f_tensor, use_C_tensor, batch_size, shuffle=True):
    ...
    """
    dataset = data_loader.SamplesDataset(path, input_length_sequence, input_length_tensor_sequence, use_material_properties_list, use_f_tensor, use_C_tensor)
